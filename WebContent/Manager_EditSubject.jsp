			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					...
					<div class="container">
						...
						<div class="container">
							<form action="" id="editsub">
								<label for="subid">SubID</label> <input type="text" name="subid" id="subid" placeholder="151" />
							    <label	for="subname">SubName</label> <input type="text" name="subname" id="subname" placeholder="Toan" />
							    <label for="nclass">Class</label> <input type="text" name="nclass" id="nclass" placeholder="7" />


								<button type="submit" id ="btnsave">SAVE</button>
								<button type="submit" id = "btncancel" onclick="location.href='Manager_EditSubject.jsp';">CANCEL</button>
