...
<link href="CSS/Student_ExamRes.css" rel="stylesheet" type="text/css">
<script
			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li><a href="Student_Person.jsp"><i class="fa fa-user" aria-hidden="true"></i><span
						...
						<!-- <li><a href="#"><i class="fa fa-calendar"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manage
									Users</span></a></li> -->
						<li class="active"><a href="Student_ExamRes.jsp"><i class="fa fa-star" aria-hidden="true"></i><span
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td> <a
										class="link_quiz"
										href="http://localhost:1443/Project2_QuizOnline/Student_Exam.jsp"
