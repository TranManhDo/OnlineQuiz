			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li><a href="admin_roleuserjsp.jsp"><i class="fa fa-user" aria-hidden="true"></i><span
								class="hidden-xs hidden-sm">Manage Role</span></a></li>
						<li><a href="http://admin_user.jsp"><i class="fa fa-calendar"
						...
						<li><a href="Admin_Class.jsp"><i class="fa fa-flag-o"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manager
									Class </span></a></li>
						<li class = "active"><a href="Admin_ChangePass.jsp"><i class="fa fa-sign-out"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Change Password</span></a></li>
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					...
					<div class="container">
						...
						<div class="container">
							<form action="ChangePassAdminController" id="changepass" method="post">
								...
								<label for="currentpassword">Current Password</label> <input type="password"
									...
									placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;" />
									<label for="cfpassword"> Confirm Password</label> <input type="password"
									name="cfpassword" id="cfpassword"
									placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;" />
								<button type="submit" id = "btnsave"  onclick="return confirm('Saved!')">SAVE</button>
								<button type="submit" id = "btncancel" onclick="location.href='Admin_ChangePass.jsp';">CANCEL</button>
