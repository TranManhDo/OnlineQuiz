			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li class="active"><a href="Manager_BankQuestions.jsp"><i class="fa fa-calendar"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manage
									Bank Questions</span></a></li>
						<li><a href=""><i class="fa fa-key" aria-hidden="true"></i><span
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					...
					<div class="container">
						...
						<div class="container">
							<form action="" id="editques">
								<label for="quesid">QuestionID</label> <input type="text" name="quesid" id="quesid" placeholder="151" />
							    <label	for="subid">SubName</label> <input type="text" name="subid" id="subid" placeholder="MATH" />
							    <label for="content">Content</label> <input type="text" name="content" id="content" placeholder="abcd?" />
							    <label for="answera">Answer A</label> <input type="text" name="answera" id="answera" placeholder="a" />
							    <label for="answerb">Answer B</label> <input type="text" name="answerb" id="answerb" placeholder="b" />
							    <label for="answerc">Answer C</label> <input type="text" name="answerc" id="answerc" placeholder="c" />
							    <label for="answerd">Answer D</label> <input type="text" name="answerd" id="answerd" placeholder="d" />
								
								
								<center><label>Correct Answer</label><select>
									<option>A</option>
									<option>B</option>
									<option>C</option>
									<option>D</option>
								...
								<button type="submit" id = "btncancel" onclick="location.href='Manager_EditQuestion.jsp';">CANCEL</button>
