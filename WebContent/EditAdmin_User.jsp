			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				<div class="row">
					...
					<div class="container">
						...
						<div class="container">
							<form action="UpdateUser_Controller" id="edituser" method="post">
								<label for="username">Username</label> <input type="text"
									name="username" id="username" placeholder="John123" /> <label
									for="fullname">Fullname</label> <input type="text"
									name="fullname" id="fullname" placeholder="JohnHand" /> <label
									for="password">Password</label> <input type="password"
									name="password" id="password"
									placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;" /> <label
									for="email">Email</label> <input type="text" name="email"
									id="email" placeholder="John123@gmail.com" /> <label
									for="birthday">BirthDay</label> <input type="text"
									name="birthday" id="birthday" placeholder="23/7/1997" /> <label
									for="sex">Sex</label> <input type="text" name="sex" id="sex"
									placeholder="nam" /> <label for="class">Class</label> <select
									name="class" style="width: 200px;color: black;">
									<%
										Connection cnn = null;
										Statement stm = null;
										ResultSet rs = null;
								...
								<button type="submit" id="btncancel"
									onclick="location.href='EditAdmin_User.jsp';">CANCEL</button>
