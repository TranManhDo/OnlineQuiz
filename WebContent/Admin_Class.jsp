			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li class="active"><a href="admin_roleuserjsp.jsp"><i
    ...
    <form method="post">
							...
							<tbody>
								...
								<tr>
									...
									<td><button type="submit" formaction="DelClass_Controller"
											class="btn btn-success" value="<%=rs.getString("ClassID")%>"
											name="delete">
						...
						<div class="container">
							<center>
								<button type="button" class="btn btn-success"
									onclick="location.href='AddAdmin_Class.jsp';">
