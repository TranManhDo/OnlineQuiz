			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li><a href="admin_user.jsp"><i class="fa fa-calendar"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manage
									Users</span></a></li>
						<li><a href="Admin_News.jsp"><i class="fa fa-flag-o"
					...
					<div class="container">
						...
						<div class="container">
							<form action="" name="role">
								<label for="userid">UserID</label> <input type="text" name="userid" id="userid" placeholder="151" />
								<label for="username">Username</label> <input type="text" name="username" id="username" placeholder="duy151" />
								<label for="fullname">Fullname</label> <input type="text" name="fullname" id="fullname" placeholder="lethaiduy" />
								
								<center><label>Role</label><select>
									<option>Admin</option>
									<option>Manager Bank Question</option>
									<option>Manager Question</option>
