			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li class="active"><a href="Student_ChangePass.jsp"><i class="fa fa-key" aria-hidden="true"></i><span
					...
					<div class="container">
						...
						<div class="container">
							<form action="" id="changepass">
								...
								<button type="submit" id = "btncancel" onclick="location.href='Student_ChangePass.jsp';">CANCEL</button>
