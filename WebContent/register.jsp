...
<link href="Bootstrap/js/bootstrap-theme.min.js" rel="stylesheet">
	...
	<div class="container">
		<form action="RegisterController" method="post">
			<label for="username">Username</label> <input type="text"
				...
				id="fullname" placeholder="JohnHand" /> <label for="password">Password</label>
			<input type="password" name="password" id="password"
				placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;" /> <label
				for="confirm_password"> Confirm Password</label> <input
				type="confirm_password" name="confirm_password"
				id="confirm_password"
				placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;" /> <label
				for="email">Email</label> <input type="text" name="email" id="email"
				placeholder="John123@gmail.com" /> <label for="birthday">BirthDay</label>
			<input type="text" name="birthday" id="birthday"
				placeholder="23/7/1997" /> <label for="sex">Sex</label> <input
				type="text" name="sex" id="sex" placeholder="nam" />
		 <label for="Class">Class</label>
		   <select name="class" style ="width: 200px;color:black;">
			...
			<select  name ="role" style ="width: 200px;color:black">
			<%
