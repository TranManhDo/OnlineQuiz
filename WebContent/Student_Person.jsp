...
<link href="CSS/Student_Person.css" rel="stylesheet" type="text/css">
			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li class="active"><a href="Student_Person.jsp"><i class="fa fa-user" aria-hidden="true"></i><span
								class="hidden-xs hidden-sm">Personal page</span></a></li>
						<li><a href="Student_ChangePass.jsp"><i class="fa fa-key" aria-hidden="true"></i><span
						...
						<!-- <li><a href="#"><i class="fa fa-calendar"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manage
									Users</span></a></li> -->
						<li><a href="Student_ExamRes.jsp"><i class="fa fa-star" aria-hidden="true"></i><span
						...
						<div class="container">
							<form action="" name="registration">
								<label for="userid">UserID</label> <input type="text"
									name="userid" id="userid" placeholder="151" /> <label
									for="password">Password</label> <input type="password"
									name="password" id="password" placeholder="lethaiduy1996" /> <label
									for="username">Username</label> <input type="text"
									name="username" id="username" placeholder="duy151" /> <label
									for="fullname">Fullname</label> <input type="text"
									name="fullname" id="fullname" placeholder="lethaiduy" /> <label
									for="birthday">Birthday</label> <input type="text"
									name="birthday" id="birthday" placeholder="02/02/1996" /> <label
									for="email">Email</label> <input type="text" name="email"
									id="email" placeholder="lethaiduy1996" />
								<label for="classname">Classname</label> <input type="text"
									name="classname" id="classname" placeholder="15A" />
