			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					...
					<div class="container">
						...
						<div class="container">
							<form action="ChangePs_ManaQs_Controller" id="changepass" method="post">
							<label for="username"> UsernName <input type="username" name="username" id="username" placeholder="do123" /> 
								...
								<button type="submit" id = "btncancel" onclick="location.href='Manager_ChangePassword.jsp';">CANCEL</button>
