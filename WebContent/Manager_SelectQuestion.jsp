			...
			<div
				...
				<div class="navi">
					<ul>
						...
						<li><a href="Manager_ChangePassword.jsp"><i
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				<div class="row">
					...
					<div class="col-md-7">
						...
						<form>
							<input type="text" name="search" placeholder="Enter QuestionId"
								id="search-text">
					...
					<div class="container">
						<br> <br> <br>
						<form action="SelectQuestion_Controller" method="post">
							<h2>Select Quesstion</h2>
								...
								<tbody>
									<%
										...
										try {
											...
											rs = stm.executeQuery(
													"select   q. QstID,s.SubjectName,q.QstContent from dbo.Question q, dbo.Subject s where  s.SubjectID=q.SubID");
											while (rs.next()) {
									%>
									<tr>
