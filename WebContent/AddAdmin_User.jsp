			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					...
					<div class="container">
						...
						<div class="container">
							<form action="AddUser_Controller" name="adduser" method="post">
								<label for="username">Username</label> <input type="text"
									...
									for="sex">Sex</label> <input type="text" name="sex" id="sex"
									placeholder="nam" /> <label for="email">Email</label> <input
									type="text" name="email" id="email" placeholder="lethaiduy1996" />
                                 <label for="class">Class</label>
								<select name="class" style="width: 200px;color: black;">
									<%
										Connection cnn = null;
										Statement stm = null;
										ResultSet rs = null;
									...
									%>
								</select> <br> <label for="role">Role</label> <select name="role"
								style="width: 200px;color: black;">
									<%
										try {
											Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
											cnn = DriverManager.getConnection(
													"jdbc:sqlserver://localhost:1433;" + "databaseName=DBOnlineQuiz;integratedSecurity=True");
											stm = cnn.createStatement();
