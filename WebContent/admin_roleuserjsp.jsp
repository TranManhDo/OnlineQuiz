		...
		<div class="row display-table-row">
			<div
				...
				<div class="navi">
					<ul>
						...
						<li class="active"><a href="admin_roleuserjsp.jsp"><i class="fa fa-user" aria-hidden="true"></i><span
						...
						<li><a href="Admin_Class.jsp"><i class="fa fa-flag-o"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Manager
									Class </span></a></li>
						<li ><a href="Admin_ChangePass.jsp"><i class="fa fa-sign-out"
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					...
					<div class="container">
						<br> <br> <br>
                    <form  action="DelRole_Controller" method="post">
							...
							<%
										...
										try {
											...
											rs = stm.executeQuery("select RoleID,RoleName from tbl_Role");
											while (rs.next()) {
									%>
									<tr>
										...
										<td><button type="submit" class="btn btn-success"
												value="<%=rs.getString("RoleID")%>" name="delete">
						...
						<div class="container">
							<center>
								<button type="button" class="btn btn-success" onclick="location.href='AddAdmin_Role.jsp';">
