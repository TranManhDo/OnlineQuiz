		...
		<div class="row display-table-row">
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				<div class="row">
					...
					<div class="container">
						<br> <br> <br>
						<form action="DelQuestion_Controller" method="post">
								...
								<tbody>
									<%
										...
										try {
											...
											rs = stm.executeQuery(
													"select   q. QstID,s.SubjectName,q.QstContent,a.OptContent ,a.TrueFaile from dbo.Answer a,dbo.Question q, dbo.Subject s where a.QstID=q.QstID and s.SubjectID=q.SubID");
											while (rs.next()) {
									%>

									<tr>

										<td><%=rs.getString("QstID")%></td>
										<td><%=rs.getString("SubjectName")%></td>
										<td><%=rs.getString("QstContent")%></td>
										<td><%=rs.getString("OptContent")%></td>
										<td><%=rs.getString("TrueFaile")%></td>

										<td><button type="submit" class="btn btn-success"
												value="<%=rs.getString("QstID")%>" name="delete">
						...
						<div class="container">
							<center>
								<button type="button" class="btn btn-success"
									onclick="location.href='Manager_AddQuestion.jsp';">
